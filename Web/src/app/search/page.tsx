                                ...
                                {results.users.length > 0 ? results.users.map((user) => (
                                    ...
                                    >
                                        <Link href={`/profile/${user.username}`}>
                                            <Image src={user.avatar || "https://api.dicebear.com/7.x/avataaars/svg?seed=friend"} width={64} height={64} unoptimized className="w-16 h-16 rounded-full border-2 border-primary/20 object-cover" alt={user.name} />
                                        </Link>
